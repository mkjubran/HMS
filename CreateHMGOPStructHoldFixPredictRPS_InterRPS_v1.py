...
parser.add_argument('--PBBB', type=str,
                    help='PBBB structure?: yes / no ')
...
def Build_encoding_struct_GOP_4():
## Building encoding structure for GOP=-1
        cnt=0
        GOPLine=''
        cnt3=-1
        ...
        cnt3=-1
        NumRefTemp=ref_pics_active_Max
        GOPLine='Frame2: B 2 0 -6.5 0.2590 0 0 1.0 0 0 0 '+ str(ref_pics_active_Max) + ' ' + str(ref_pics_active_Max)
        for cnt1 in range(NumRefTemp):
                if cnt1>(NumRefTemp-ref_pics_active_Stitching-1):
                        print((ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt]))
                        GOPLine=GOPLine+' '+str(ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt])
        ...
        cnt3=-1
        NumRefTemp=ref_pics_active_Max
        GOPLine='Frame3: B 3 0 -6.5 0.2590 0 0 1.0 0 0 0 '+ str(ref_pics_active_Max) + ' ' + str(ref_pics_active_Max)
        for cnt1 in range(NumRefTemp):
                if cnt1>(NumRefTemp-ref_pics_active_Stitching-1):
                        print((ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt]))
                        GOPLine=GOPLine+' '+str(ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt])
        ...
        cnt3=-1
        NumRefTemp=ref_pics_active_Max
        GOPLine='Frame4: B 4 0 -6.5 0.2590 0 0 1.0 0 0 0 '+ str(ref_pics_active_Max) + ' ' + str(ref_pics_active_Max)
        for cnt1 in range(NumRefTemp):
                if cnt1>(NumRefTemp-ref_pics_active_Stitching-1):
                        print((ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt]))
                        GOPLine=GOPLine+' '+str(ref_pics_Stitching_array[cnt1-(NumRefTemp-ref_pics_active_Stitching)]-iFNums_array[cnt])
...
if __name__ == '__main__':
   ...
   elif (PBBB == "yes") or (PBBB == "Yes"):
      Build_encoding_struct_GOP_4()
   else:
