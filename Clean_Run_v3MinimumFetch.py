...
while os.listdir(in_path) and (cnt < 3):
   ...
   if os.path.exists('./rate_{}.txt'.format(in_dir)):
      ...
      for filename in content:
         f = '{}'.format(filename.split(' ')[0]).split("'")[1].split('/')[-1]
         #pdb.set_trace()
         if os.path.exists('./preproc/{}/{}'.format(in_dir,f)):
            #call('cp -rf ./preproc/{}/{} ./preproc/{}_Completed/.'.format(in_dir,f,in_dir))
   ...
   if GPU == 0:
      ...
      try:
         call('python3 run_with_minimal_fetch_and_paths.py --gpu 0 --lr 0 --rps_size 1 --mode test --l1_weight 10 --output_dir {} --max_epochs 1 --checkpoint {} --input_dir ./preproc/{} --which_direction AtoB'.format(LABEL,LABEL,in_dir));
      finally:
      ...
      try:
         call('python3 run_with_minimal_fetch_and_paths_2.py --gpu 1 --lr 0 --rps_size 1 --mode test --l1_weight 10 --output_dir {} --max_epochs 1 --checkpoint {} --input_dir ./preproc/{} --which_direction AtoB'.format(LABEL,LABEL,in_dir));
      finally:
