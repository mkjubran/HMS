...
if __name__ == '__main__':
   ...
   if f1_numFrames > f2_numFrames:
      ...
      f1_FNum_VMAF=f1_FNum_VMAF[0:f2_numFrames,:]
      nfc=f2_numFrames
   else:
      f2_FNum_Rate_PSNR=f2_FNum_Rate_PSNR[0:f1_numFrames,:]
      f2_FNum_VMAF=f2_FNum_VMAF[0:f1_numFrames,:]
      nfc=f1_numFrames

   if (nf != 0) and (nf <= f1_numFrames) and (nf <= f2_numFrames):
	f1_FNum_Rate_PSNR=f1_FNum_Rate_PSNR[0:nf,:]
	f2_FNum_Rate_PSNR=f2_FNum_Rate_PSNR[0:nf,:]
	f1_FNum_VMAF=f1_FNum_VMAF[0:nf,:]
	f2_FNum_VMAF=f2_FNum_VMAF[0:nf,:]
	nfc=nf
...
#   print("Fn2 ({}): #Frames= {}, Rate={} kbps, PSNR={} dB, VMAF={}").format(Lfname2,f2_numFrames,TotalRatefn2,TotalPSNRfn2,TotalVMAFfn2)
   ...
   print("{}	{}	{}	{}	{}").format(f2_numFrames,int(R2),TotalRatefn2,TotalPSNRfn2,TotalVMAFfn2)
